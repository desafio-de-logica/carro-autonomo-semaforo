...
while (velocidade_veiculo > velocidade_parado) {
    ...
    if (sinal_cor == 'verde') {
        ...
        } else { // isso causa um efeito inesperado, qualquer coisa diferente de verde ou amarelo diminui a velocidade
            if (velocidade_veiculo > velocidade_parado) {
    ...
    let sinal_novo = window.prompt('Qual a cor do sinal?');
